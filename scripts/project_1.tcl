...
#
# Generated by Vivado on Tue Feb 18 10:08:46 CET 2025
...
set_property -name "webtalk.xsim_launch_sim" -value "224" -objects $obj
...
# nano_rv32i
  ...
  set_property -dict [list \
    ...
    CONFIG.C_IS_DUAL {0} \
    CONFIG.C_TRI_DEFAULT {0x000000F0} \
  ] $axi_gpio_0
  ...
  set_property -dict [list \
    CONFIG.Coe_File {/home/pxdrom/Documents/nanorv32/coe/init_mem_2.coe} \
  ...
  connect_bd_net -net clk_i_0_1 [get_bd_ports clk_i_0] [get_bd_pins blk_mem_gen_1/clka] [get_bd_pins nano_rv32i_0/clk_i] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins blk_mem_gen_0/clka]
  ...
  connect_bd_net -net nano_rv32i_0_i_addr_o [get_bd_pins nano_rv32i_0/i_addr_o] [get_bd_pins ila_0/probe4] [get_bd_pins blk_mem_gen_0/addra]
  ...
  connect_bd_net -net nano_rv32i_0_s_axi_awaddr_o [get_bd_pins nano_rv32i_0/s_axi_awaddr_o] [get_bd_pins ila_0/probe0] [get_bd_pins axi_gpio_0/s_axi_awaddr]
  connect_bd_net -net nano_rv32i_0_s_axi_awvalid_o [get_bd_pins nano_rv32i_0/s_axi_awvalid_o] [get_bd_pins ila_0/probe2] [get_bd_pins axi_gpio_0/s_axi_awvalid]
  ...
  connect_bd_net -net nano_rv32i_0_s_axi_wdata_o [get_bd_pins nano_rv32i_0/s_axi_wdata_o] [get_bd_pins ila_0/probe3] [get_bd_pins axi_gpio_0/s_axi_wdata]
  connect_bd_net -net nano_rv32i_0_s_axi_wvalid_o [get_bd_pins nano_rv32i_0/s_axi_wvalid_o] [get_bd_pins ila_0/probe6] [get_bd_pins axi_gpio_0/s_axi_wvalid]
  connect_bd_net -net rst_n_i_0_1 [get_bd_ports rst_n_i_0] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins nano_rv32i_0/rst_n_i] [get_bd_pins ila_0/probe7] [get_bd_pins axi_gpio_0/s_axi_aresetn]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.765004",
   "Default View_TopLeft":"63,0",
...
preplace netloc axi_gpio_0_s_axi_arready 1 3 2 1030 40 1570J
preplace netloc axi_gpio_0_s_axi_awready 1 3 2 1000 430 1570
...
preplace netloc clk_2_1 1 0 5 NJ 810 NJ 810 NJ 810 NJ 810 1550
...
preplace netloc nano_rv32i_0_s_axi_awaddr_o 1 4 1 1540 220n
...
preplace netloc rst_n_i_0_1 1 0 5 20 260 NJ 260 610J 280 970 610 1560
...
preplace netloc xlconstant_1_dout 1 5 1 1890 370n
